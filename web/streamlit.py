...
with col1:
    st.image("visualization/daily_spending_trends.png", caption="📅 Daily Spending Trends", use_container_width=True)
    st.image("visualization/payment_methods.png", caption="💳 Most Common Payment Methods", use_container_width=True)

with col2:
    st.image("visualization/peak_spending_hours.png", caption="⏰ Peak Spending Hours", use_container_width=True)
    st.image("visualization/spending_vs_location.png", caption="🌎 Spending vs City Population", use_container_width=True)

st.image("visualization/top_spending_categories_amount.png", caption="🛒 Top Spending Categories by Amount", use_container_width=True)
st.image("visualization/top_spending_categories_volume.png", caption="🔢 Top Spending Categories by Volume", use_container_width=True)
